...
public class DownstreamMessage_gest extends AsyncTask<String,String,String>
{
//    AsyncResponse delegate = null;
    ...
    protected String doInBackground(String... params)
    {
        ...
        try
        {
            ...
            try
            {
                notification_json_object.put("body","sommeone reponse to your book tab to see who");
            }
            ...
            try
            {
                ...
                data.put("respone",gust_response);
            }
            catch (JSONException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
