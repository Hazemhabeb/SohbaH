...
//        setFont.changeFonts(Intro.this,(LinearLayout)findViewById(R.id.pagerid));
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Typeface myTypeface = Typeface.createFromAsset(getAssets(), getApplication().getString(R.string.font_regular));
            titleView.setTypeface(myTypeface);
            hintView.setTypeface(myTypeface);
